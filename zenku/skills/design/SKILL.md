...
**Go down until you hit something you cannot settle.** That is the stopping rule, and it is the same thing as a trial: shaping a journey usually stops partway down level 1 or 2, because that is exactly where the trials surface. Building goes all the way to the bottom, because by then there are none left.
