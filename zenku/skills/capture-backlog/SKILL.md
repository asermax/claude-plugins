...
- Something real to find out → **say so and offer `zenku:capture-idea` instead.** A bug pushed through a shaping lifecycle produces states that mean nothing, and the decision skills have nothing sensible to do with it.
