...
If this needs something found out before it can start, it is not a work item. It is an objective with an unknown, and it belongs in the experiment backlog.
