...
**The objective is a goal, not a question in disguise.** An objective says what someone wants to be able to do. It does not come out true or false and it does not need to be falsifiable — falsifiability lives one level down, in the unknowns. An "objective" phrased as "can we…" or "should we…" or "is X better than Y" is a question that has been promoted a level, and it will produce an experiment with nothing above it to be decided. Flag it and say what the underlying goal appears to be.
