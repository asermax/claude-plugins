...
What the pattern is, stated prescriptively: "When <situation>, do <mechanism>."

## Rationale

Why this pattern, grounded in evidence where available.

## How to apply

Concrete steps or a canonical example.

## Where it is used

- `<module / feature>` — <how it applies here>.
